...
OUTFILE="Cdis_x_Xtex.simulated.3gen.newhybrids"
...
./genepop2newhybrids.pl -m Cdis_x_Xtex.map.txt -o $OUTFILE -g $INFILE -z Cdis_pure -Z Xtex_pure > "${OUTFILE}.sampleOrder.txt"
