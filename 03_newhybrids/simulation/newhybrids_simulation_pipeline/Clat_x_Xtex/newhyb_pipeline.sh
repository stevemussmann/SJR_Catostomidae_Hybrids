...
#set arguments
popmap="Clat_x_Xtex_map.txt"
phylip="populations.snps.recode.min4.phy"

#target populations
p1="Clat_pure"
p2="Xtex_pure"
pH="CdisW21SJR+ClatW19SJR+ClatW21SJR+ClatW21SJR_age1+ClatW21SJR_PSU+ClatXW19SJR+ClatXW20SJR+ClatXW21SJR+CspW19SJR+CspW20SJR+CspW21SJR+XtexW11SJR_JUV+XtexW12SJR_JUV+XtexW13SJR_JUV+XtexW14SJR_JUV+XtexW16SJR_JUV+XtexW17SJR_JUV+XtexW18SJR_JUV+XtexW19SJR_age1+XtexW19SJR_JUV+XtexW20SJR_ADULT+XtexW20SJR_age1+XtexW20SJR_LARVAE+XtexW21SJR_age1+XtexW21SJR_JUV"
...
#paths
rpath=/home/mussmann/miniconda3/envs/R/bin/Rscript #path to Rscript 
pipeline=/home/mussmann/local/scripts/bash/newhyb_pipeline #path to newhyb_pipeline directory
nh_path=/home/mussmann/local/bin/newhybrids #path to newhybng binary
