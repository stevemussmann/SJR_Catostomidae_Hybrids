...
#set arguments
popmap="Cdis_x_Clat_map.txt"
phylip="populations.snps.recode.min4.phy"

#target populations
p1="Cdis_pure"
p2="Clat_pure"
pH="CdisW19SJR+CdisW21SJR+ClatW19SJR+ClatW21SJR+ClatW21SJR_age1+ClatW21SJR_PSU+CspW20SJR+CspW21SJR+XtexW19SJR_JUV+XtexW21SJR_age1+XtexW21SJR_JUV"
