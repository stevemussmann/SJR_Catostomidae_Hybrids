# Flannelmouth Sucker x Razorback Sucker entropy
...
1. Run `twospecies.sh` which uses the `Clat_x_Xtex_map.txt` file to pull only these two species from the filtered VCF file produced during running admixpipe
