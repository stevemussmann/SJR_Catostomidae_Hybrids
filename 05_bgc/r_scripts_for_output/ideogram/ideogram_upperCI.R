...
outliercoords <- read.table("coords_upperCI.txt", sep="\t", header=TRUE)
alphacoords <- read.table("alpha_upperCI.txt", sep="\t", header=TRUE)
betacoords <- read.table("beta_upperCI.txt", sep="\t", header=TRUE)
allcoords <- read.table("coords_upperCI_all.txt", sep="\t", header=TRUE)
