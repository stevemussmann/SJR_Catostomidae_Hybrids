...
outliercoords <- read.table("coords_mean.txt", sep="\t", header=TRUE)
alphacoords <- read.table("alpha_mean.txt", sep="\t", header=TRUE)
betacoords <- read.table("beta_mean.txt", sep="\t", header=TRUE)
allcoords <- read.table("coords_mean_all.txt", sep="\t", header=TRUE)
